...
export function ComplexCalPage() {
  ...
  return (
    <div className="complex-cal-page">
      ...
      <main className="dash-container">
        <div className="dash-header">
          <h2>Análise de Risco Completa (NBR 5419)</h2>
          <p>Informe os parâmetros da estrutura e das linhas conectadas para realizar o estudo detalhado.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="calculation-form">
          <fieldset className="form-fieldset">
            ...
            <div className="ng-manual-group">
              ...
              >
                Não sabe o valor? Pesquise no mapa de densidade do INPE/ELAT ↗
              </a>
            </div>
          </fieldset>
          ...
          <button type="submit" className="submit-button" disabled={isLoading}>
            {isLoading ? "Calculando..." : "Analisar Risco"}
          </button>
        </form>
          ...
          <div className="result-container">
            <div className="result-box">
              ...
              <div className="result-grid">
                ...
                <ResultRow label="R3 (Risco de Perda de Patrimônio Cultural)" analysis={result.analysis.R3} />
                <ResultRow label="R4 (Risco de Perda de Valor Econômico)" analysis={result.analysis.R4} />
              </div>
            </div>
          </div>
        )}
