  ...
  const result = useMemo(() => {
    ...
    return {
      ...
      mensagem: necessitaProtecao
        ...
        : "Proteção contra descargas atmosféricas é opcional.",
    };
  }, [inputs]);
    ...
    <div className="simple-calc-page">
      ...
      <main className="dash-container">
        <div className="dash-header">
          <h2>Avaliação de Risco Simplificada</h2>
          <p>Informe os parâmetros principais da estrutura para obter uma estimativa inicial rápida.</p>
        </div>
          ...
          <div className="simple-calc-results">
            ...
            <div className="result-summary">
              <div className="result-item">
                <span>Área de Coleta (Ad):</span>
                <span className="result-value">{result.Ad} m²</span>
              </div>
              <div className="result-item">
                <span>Ameaça Anual (Nd):</span>
              ...
              <div className="result-item">
                <span>Coeficiente Combinado (C):</span>
